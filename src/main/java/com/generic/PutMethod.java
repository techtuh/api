...
public class PutMethod {
	...
	public void getSetup() {
		...
		jo.addProperty("name", " Abdullah");
		jo.addProperty("salary", 6000);
		...
		responseObj =	rs.post("https://httpbin.org/put");
...
//json.name = json is patent
		softAssert.assertEquals(jsonpath.get("json.name"), " Abdullah");
